...
export async function generateAllFixtures() {
  ...
  const files = {
    ...
    testImagePng: createTestImage({ width: 800, height: 600, filename: 'test-image.png', text: 'PNG Test' }),
    testImageJpg: createTestImage({ width: 800, height: 600, filename: 'test-image.jpg', text: 'JPG Test' }),
